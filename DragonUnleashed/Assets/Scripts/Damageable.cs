...
public class Damageable : MonoBehaviour
{
	...
	protected void DamageUpdate()
	{
		if (lastIntegrityUpdate != CurrentLocalIntegrity)
		{
			...
			if (lastIntegrityUpdate != CurrentLocalIntegrity && PhotonNetwork.isMasterClient)
			{
				GetComponent<PhotonView>().RPC("SetIntegrity", PhotonTargets.AllBuffered, CurrentLocalIntegrity);
			}
	...
	public void PropDamageUpdate()
	{
		CurrentIntegrity = CurrentLocalIntegrity;
		lastIntegrityUpdate = CurrentLocalIntegrity;
	}
}
