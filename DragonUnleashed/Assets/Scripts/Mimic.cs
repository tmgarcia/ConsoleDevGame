...
public class Mimic : MonoBehaviour {
	...
	void Update () {
        ...
        //    ((CapsuleCollider)trueForm.collider).center = gameObject.GetComponent<CapsuleCollider>().center;
        //    ((CapsuleCollider)trueForm.collider).radius = gameObject.GetComponent<CapsuleCollider>().radius;
        //    ((CapsuleCollider)trueForm.collider).height = gameObject.GetComponent<CapsuleCollider>().height;
        //    ((CapsuleCollider)trueForm.collider).direction = gameObject.GetComponent<CapsuleCollider>().direction;
        //
